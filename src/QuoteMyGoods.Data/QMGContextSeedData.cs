...
namespace QuoteMyGoods.Data
{
    public class QMGContextSeedData
    {
        ...
        public QMGContextSeedData(ProductContext context, UserManager<IdentityUser> userManager, ILogger<QMGContextSeedData> logger, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
        ...
        public async Task EnsureSeedDataAsync()
        {
            ...
            if (!_context.Products.Any())
            {
                ...
                var mahoganyTimber = new ProductDM()
                {
                    Name = "Mahogany Plank",
                    Category = "Timber",
                ...
                var philipsHeadScrewdriver = new ProductDM()
                {
                ...
                var flatHeadScrewdriver = new ProductDM()
                {
                ...
                var insulatingBricks = new ProductDM()
                {
                ...
                var angleGrinder = new ProductDM()
                {
                    Name = "Angle Grinder",
                    Category = "Tools",
                ...
                var smartMaterials = new ProductDM()
                {
